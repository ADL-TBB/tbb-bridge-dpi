...
def log(hypernodes, setting, training_data, valid_data, test_data):
    logger.debug(f'Conditions --> hypernodes: {number_of_graph_nodes}, pEmbeddings: {setting["pEmbeddings"]}, kmers: {setting["kmers"]}, pSeq: {setting["pSeq"]}, FP: {setting["FP"]}, dSeq: {setting["dSeq"]}, ST_fingerprint: {setting["ST_fingerprint"]}\n')
